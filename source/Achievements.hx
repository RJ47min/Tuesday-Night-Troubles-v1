...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Freaky on a Tuesday Night", "Play on a Tuesday... Night.", 'tuesday_night_play', true],
		["Good job dude", "Beat Chapter 1", 'Beat_Chap1', false],
        ["Awesome work dude", "FC Chapter 1", 'FC_Chap1', false]
	];
